...
class TheMinimalist_Customizer {
    ...
    private function social_callout_section( $wp_customize ) {
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control1', array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control3', array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control4', array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control5', array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control6', array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control7', array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control8', array(
        ...
        $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'social-image-control9', array(
    ...
    private function actualite_callout_section( $wp_customize ) {
		...
		// New section for "Actualites".
        $wp_customize->add_section('actualite', array(
            'title' => 'Actualite settings',
            'priority' => 2,
            'description' => __('Actualite section settings', 'bravada-child'),
        ));    
        ...
        $wp_customize->add_control('actualite_text_control',array(
            'label'=>__('actualite text', 'bravada-child'),            
            'type'=>'textarea',
            'section'=>'actualite',
